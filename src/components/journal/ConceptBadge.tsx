...
> = {
  ...
  phrase: { label: "Frase", className: "bg-purple-100 text-purple-700 border-purple-200" },
  grammar: { label: "Gramática", className: "bg-amber-100 text-amber-700 border-amber-200" },
  idiom: { label: "Modismo", className: "bg-green-100 text-green-700 border-green-200" },
